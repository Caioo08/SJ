...
*{box-sizing:border-box;font-family:Inter,Arial,sans-serif}body{margin:0;background:var(--bg);color:var(--txt)}
.layout{display:grid;grid-template-columns:320px 1fr;min-height:100vh}
.panel{border-right:1px solid var(--bd);padding:16px;background:var(--card)}
.chat{padding:16px;display:flex;flex-direction:column}
.cliente{padding:10px;border:1px solid var(--bd);border-radius:10px;margin-bottom:8px;display:block;color:var(--txt);text-decoration:none}
.cliente.active{border-color:var(--acc);background:rgba(212,175,55,.1)}
.msgs{flex:1;overflow:auto;border:1px solid var(--bd);border-radius:10px;padding:12px;background:#121212}
.msg{max-width:75%;padding:10px;border-radius:10px;margin-bottom:8px}
...
@media(max-width:980px){.layout{grid-template-columns:1fr}.panel{border-right:none;border-bottom:1px solid var(--bd)}}
</style>
</head>
<body>
<div class="layout">
