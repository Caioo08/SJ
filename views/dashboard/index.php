...
<main class="main-content">
    ...
    <section class="info-section" style="margin-top:0;">
        ...
        <h3 style="font-size:15px;color:var(--accent);margin:4px 0 8px;">Carga por advogado (ranking)</h3>
        <?php if (empty($carga_advogados)): ?>
            <p class="mut">Sem dados de ranking no período selecionado.</p>
        <?php else: ?>
            <table class="ranking-table">
                ...
                <tbody>
                <?php foreach ($carga_advogados as $linha): ?>
                    <tr>
                        <td><?= htmlspecialchars($linha['nome']) ?></td>
                        <td><?= (int)$linha['total_processos'] ?></td>
                        <td><?= (int)$linha['processos_abertos'] ?></td>
                        <td><?= (int)$linha['prazos_abertos'] ?></td>
                        <td><strong><?= (int)$linha['carga_total'] ?></strong></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
