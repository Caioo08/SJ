...
<div class="container">
    <div class="card">
        ...
        <?php if($processos_vinculados > 0): ?>
            <div class="warning-box">
                <p>
                    ⚠️ <strong>Atenção:</strong> Este cliente possui <strong><?= $processos_vinculados ?></strong> 
                    processo(s) vinculado(s). Ao excluir o cliente, os processos permanecerão no sistema mas 
                    perderão o vínculo com os dados completos do cliente.
                </p>
            </div>
        <?php endif; ?>
        ...
        <form action="/clientes/delete/<?= $cliente['id'] ?>" method="POST">
            ...
            <div class="buttons">
                <a href="/clientes" class="btn btn-cancel">Cancelar</a>
