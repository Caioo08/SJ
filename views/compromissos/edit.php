...
<head>
<meta charset="UTF-8">
<title>Editar Compromisso - Sistema Jurídico</title>
...
<div class="container">
    <div class="card">
        <h1>✏️ Editar Compromisso</h1>
        <form action="/compromissos/update/<?= $compromisso['id'] ?>" method="POST">
            <?= Csrf::field() ?>
            ...
            <div class="form-section">
                ...
                <div class="form-group full-width">
                    ...
                    <input type="text" id="titulo" name="titulo" value="<?= htmlspecialchars($compromisso['titulo']) ?>" required>
                </div>

                <div class="form-group full-width">
                    <label for="descricao">Descrição</label>
                    <textarea id="descricao" name="descricao"><?= htmlspecialchars($compromisso['descricao']) ?></textarea>
                </div>
            </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="datetime-local" id="data_inicio" name="data_inicio" 
                               value="<?= date('Y-m-d\TH:i', strtotime($compromisso['data_inicio'])) ?>" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" id="data_fim" name="data_fim" 
                               value="<?= $compromisso['data_fim'] ? date('Y-m-d\TH:i', strtotime($compromisso['data_fim'])) : '' ?>">
            ...
            <div class="form-section">
                ...
                <div class="form-group full-width">
                    ...
                    <input type="text" id="local" name="local" value="<?= htmlspecialchars($compromisso['local']) ?>">
                </div>
            </div>
