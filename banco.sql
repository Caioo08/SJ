...
-- ============================================
-- TABELA: Modelos de Checklist (Fase C1)
-- ============================================
CREATE TABLE checklist_modelos (
    ...
    CONSTRAINT fk_checklist_modelo_usuario
        FOREIGN KEY (usuario_id) REFERENCES usuarios(id) ON DELETE CASCADE,

    INDEX idx_checklist_modelo_usuario (usuario_id),
    INDEX idx_checklist_modelo_tipo (tipo_acao),
    INDEX idx_checklist_modelo_ativo (ativo)
) ENGINE=InnoDB;
...
CREATE TABLE processo_checklist_itens (
    ...
    UNIQUE KEY uq_checklist_item_titulo (processo_id, usuario_id, titulo),
...
CREATE TABLE peticoes (
    ...
    UNIQUE KEY uq_peticoes_titulo_processo (processo_id, usuario_id, titulo),
